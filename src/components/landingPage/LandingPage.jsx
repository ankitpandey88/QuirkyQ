  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="bg-pink-600 text-white p-4 flex justify-between items-center">
        ...
        <div>
          <button
            className="bg-transparent border-2 border-white px-4 py-2 rounded-lg mr-4 hover:bg-white hover:text-pink-600 transition"
            onClick={() => navigate("/login")} // Redirect to /login
          >
            Login
          </button>
          <button
            className="bg-white text-pink-600 px-4 py-2 rounded-lg hover:bg-pink-500 hover:text-white transition"
            onClick={() => navigate("/onboarding")} // Redirect to /onboarding
          >
            Sign Up
          </button>
        </div>
